  ...
  return (
    <div className="relative w-full">
      <input
        ...
        onChange={onChange}
        className={twMerge(
          'block px-2.5 pb-2.5 pt-4 w-full text-md text-gray-900 bg-transparent rounded border appearance-none   focus:outline-none focus:ring-0 focus:border-primary peer',
          className,
        )}
