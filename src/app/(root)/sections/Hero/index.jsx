    ...
    <section className="min-h-[calc(100vh-180px)] pb-[250px]">
      <Container>
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 pt-[60px]">
          ...
          <div className="flex relative justify-center items-center pr-20 lg:w-1/2">
            <div className="relative overflow-hidden rounded-[69%_31%_70%_30%_/_30%_54%_46%_70%] w-full h-[300px] lg:w-[500px] lg:h-[500px]">
              <Image
                style={{
            ...
            {/* <div className="absolute -z-10 left-2 top-2 rounded-[69%_31%_70%_30%_/_30%_54%_46%_70%] w-full h-[300px] lg:w-[500px] lg:h-[500px] bg-primary" /> */}
          </div>
        </div>
      </Container>
    </section>
